...
namespace LibraryManagement
{
    public partial class AdminLoginPage : System.Web.UI.Page
    {
        ...
        //        connection.Open();
        //    }
        //    SqlCommand cmd = new SqlCommand("SELECT * FROM UT_Mst_User WHERE UserName ='" + txtadmLogin.Text.Trim() + "'AND Password='" + txtadmPass.Text.Trim() + "'", connection);
        ...
        {
            OP = "GetAdmin";
            //OPID = txtadmLogin.Text;
            OPID = "";
            OPID1 = txtadmPass.Text;
